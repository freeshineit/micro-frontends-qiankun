...
const Player = () => {
  ...
  const initPlayer = useCallback(() => {
    if (document.getElementById('player-container')) {
      ...
      player.current.eventEmitter.on(EZUIKitPlayer.EVENTS.videoInfo, (info: any) => {
        console.log('videoinfo', info);
      });

      player.current.eventEmitter.on(EZUIKitPlayer.EVENTS.audioInfo, (info: any) => {
        console.log('audioInfo', info);
      });

      // 首帧渲染成功
      // first frame display
      player.current.eventEmitter.on(EZUIKitPlayer.EVENTS.firstFrameDisplay, () => {
        console.log('firstFrameDisplay ');
      });
      player.current.eventEmitter.on(EZUIKitPlayer.EVENTS.streamInfoCB, (info: any) => {
